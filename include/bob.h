...
BobDispatch *BobEnterCObjectType(BobScope *scop,BobDispatch *parent,char *typeName,BobCMethod *methods,BobVPMethod *properties,long size);
BobDispatch *BobEnterCPtrObjectType(BobScope *scop,BobDispatch *parent,char *typeName,BobCMethod *methods,BobVPMethod *properties);
